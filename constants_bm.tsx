...
export const PAIN_POINTS = [
    ...
    },
    {
        ...
        description: "Prosedur mudah boleh menelan belanja ribuan ringgit, menghabiskan simpanan sekelip mata.",
        icon: DollarSign,
...
export const FEATURES: FeatureItem[] = [
    { title: "Ketelusan Yang Nyata", description: "Setiap sen yang dikongsi dipaparkan dalam Laporan Perkongsian Bulanan anda.", icon: FileSearch },
    { title: "Mampu Milik Untuk Semua", description: "Perkongsian perubatan anda dihadkan kepada RM50 sebulan.", icon: DollarSign },
    { title: "Niat Yang Murni", description: "TIADA agenda tersembunyi atau margin keuntungan. Setiap sen menyokong kes sebenar.", icon: Heart },
    { title: "Adil Untuk Semua Peringkat Umur", description: "Semua orang berkongsi kadar yang sama, tanpa mengira umur.", icon: Scale },
    { title: "Amanah Yang Terjamin", description: "Perkongsian anda hanya digunakan untuk perkongsian perubatan. Tiada pelaburan atau pengambilan untung.", icon: ShieldCheck },
    { title: "Akses Luas Seluruh Negara", description: "Akses ke 250+ hospital panel dan 4000+ klinik.", icon: MapPin },
];
