        ...
        <footer className="bg-brand-navy text-slate-300">
            ...
            <div id="join-section" className="bg-brand-surface-navy py-20 px-4 md:px-8 relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12 bg-white rounded-[2rem] shadow-2xl overflow-hidden relative border border-slate-100">
                    ...
                    <div className="w-full lg:w-1/2 text-left space-y-8 pl-8 pr-8 py-12 lg:pl-16 relative z-10">
                        <div>
                            <div className="inline-block bg-brand-navy text-white text-xs font-bold px-3 py-1 rounded-full mb-4">加入社区</div>
                            <h2 className="text-4xl md:text-5xl font-extrabold text-brand-navy leading-tight">
                                您还在 <br />
                                <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-blue to-brand-teal">等待什么？</span>
                            </h2>
                        </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mb-12">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-slate-400 mb-6 leading-relaxed max-w-xs">
                            社区驱动的医疗费用分担。负担得起、透明、公平。我们正在共同建立一个更健康的国家。
                        </p>
                    ...
                    {/* Contact */}
                    <div>
                        <h4 className="font-bold text-white text-lg mb-6">联系我们</h4>
                    ...
                    <div>
                        <h4 className="font-bold text-white text-lg mb-6">免责声明</h4>
                        <p className="text-xs text-slate-500 leading-relaxed mb-4">
                            We Kongsi 不是保险公司或伊斯兰保险。我们的计划是由会员之间自愿协议分担彼此的医疗费用驱动的。
                        </p>
                ...
                <div className="border-t border-white/10 pt-8 text-center text-sm text-slate-500">
                    &copy; {new Date().getFullYear()} We Kongsi. 版权所有。
                </div>
            </div>
        </footer>
    );
