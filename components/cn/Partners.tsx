    ...
    return (
        <Section className="bg-slate-50 relative overflow-hidden">
            ...
            <div className="text-center mb-16 relative z-10">
                <h2 className="text-3xl md:text-4xl font-bold text-brand-navy">我们的合作伙伴与合规性</h2>
                <p className="text-lg md:text-xl max-w-3xl mx-auto text-slate-600 mt-4">经过验证的合规性和值得信赖的合作，让您安心。</p>
            ...
            <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-center max-w-6xl mx-auto relative z-10">
                ...
                <div className="w-full lg:w-7/12 text-left">
                    <div className="inline-flex items-center px-3 py-1 bg-white text-brand-teal rounded-full text-xs font-bold uppercase tracking-wider mb-4 border border-brand-teal/20">
                        <ShieldCheck className="w-3 h-3 mr-2" /> 信任与安全
                    </div>

                    <h3 className="text-3xl font-bold text-brand-navy mb-2">正式获得伊斯兰教法认证</h3>
                    <p className="text-lg text-brand-blue font-medium mb-6">由 Afsha Shariah Advisory 认证和审核</p>

                    <p className="text-slate-600 mb-10 leading-relaxed">
                        We Kongsi 对公平和道德运营的承诺经过独立验证。整个 We Kongsi 计划已获得独立咨询机构 Afsha Shariah Advisory 的正式伊斯兰教法认证。此认证向每位会员保证，我们的医疗费用分担业务完全透明、合乎道德，并完全符合伊斯兰原则。请参阅右侧展示的官方证书。
                    </p>

                    <div>
                        <h4 className="text-sm font-bold text-slate-800 uppercase tracking-widest mb-4 border-b border-slate-100 pb-2 inline-block">值得信赖的技术与合规合作伙伴</h4>
