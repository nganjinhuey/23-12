...
import { MEMBERSHIP_PLANS } from '../../constants_cn';
        ...
        >
            ...
            <div className="mb-24">
                <div className="text-center mb-10">
                    <h3 className="text-2xl font-bold text-brand-navy">1. 会员费</h3>
                    <p className="text-slate-500">选择适合您预算的计划。</p>
                </div>
                            ...
                            {plan.highlight && (
                                <div className="absolute top-0 right-0 transform translate-x-2 -translate-y-2">
                                    <div className="bg-yellow-400 text-yellow-900 px-4 py-1.5 rounded-bl-xl rounded-tr-xl text-xs font-bold shadow-lg shadow-yellow-500/30 flex items-center uppercase tracking-wider">
                                        <Crown size={14} className="mr-1.5" /> 超值
                                    </div>
                                </div>
                            )}
            ...
            <div>
                <div className="text-center mb-10">
                    <h3 className="text-2xl font-bold text-brand-navy">2. 共享账户支付</h3>
                    <p className="text-slate-500">选择两种套餐之一。</p>
                </div>
                    ...
                    <div className="bg-white rounded-3xl border border-blue-200 overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 flex flex-col group h-full">
                        <div className="p-8 bg-blue-50/80 border-b border-blue-100">
                            <div className="flex justify-between items-start mb-4">
                                ...
                                <span className="bg-blue-200 text-blue-800 px-3 py-1 rounded-full text-xs font-bold uppercase">标准</span>
                            </div>
                            <h4 className="text-3xl font-bold text-blue-900">RM100</h4>
                            <p className="text-sm text-blue-600 mt-1 font-medium">余额 &lt; RM50 时自动充值</p>
                        </div>
                        <div className="p-8 flex-1 bg-white">
                            <ul className="space-y-4">
                                <li className="flex items-start text-sm text-slate-700">
                                    <Check className="w-5 h-5 text-blue-500 mr-3 shrink-0" />
                                    <span><strong>住院治疗:</strong> 高达 RM1,000,000/年</span>
                                </li>
                                <li className="flex items-start text-sm text-slate-700">
                                    <Check className="w-5 h-5 text-blue-500 mr-3 shrink-0" />
                                    <span><strong>病房与膳食:</strong> RM150/天</span>
                                </li>
                                <li className="flex items-start text-sm text-slate-700">
                                    <Check className="w-5 h-5 text-blue-500 mr-3 shrink-0" />
                                    <span><strong>救护车:</strong> RM250</span>
                                </li>
                                <li className="flex items-start text-sm text-slate-700">
                                    <Check className="w-5 h-5 text-blue-500 mr-3 shrink-0" />
                                    <span><strong>政府医院现金津贴:</strong> RM50/天</span>
                                </li>
                                <li className="flex items-start text-sm text-slate-700">
                                    <Check className="w-5 h-5 text-blue-500 mr-3 shrink-0" />
                                    <span>有条件门诊福利</span>
                    ...
                    <div className="bg-white rounded-3xl border border-cyan-200 overflow-hidden shadow-xl hover:shadow-2xl hover:scale-[1.02] transition-all duration-300 flex flex-col group relative h-full">
                        <div className="p-8 bg-cyan-50/80 border-b border-cyan-200">
                            <div className="flex justify-between items-start mb-4">
                                ...
                                <span className="bg-cyan-100 text-cyan-800 px-3 py-1 rounded-full text-xs font-bold uppercase border border-cyan-200">豪华</span>
                            </div>
                            <h4 className="text-3xl font-bold text-cyan-900">RM200</h4>
                            <p className="text-sm text-cyan-700 mt-1 font-medium">余额 &lt; RM50 时自动充值</p>
                        </div>
                        <div className="p-8 flex-1 bg-white relative">
                            <ul className="space-y-4">
                                <li className="flex items-start text-sm text-slate-700">
                                    <Check className="w-5 h-5 text-cyan-500 mr-3 shrink-0 font-bold" />
                                    <span className="font-medium text-slate-900"><strong>住院治疗:</strong> 高达 RM1,000,000/年</span>
                                </li>
                                <li className="flex items-start text-sm text-slate-700">
                                    <Check className="w-5 h-5 text-cyan-500 mr-3 shrink-0 font-bold" />
                                    <span><strong>病房与膳食:</strong> RM250/天</span>
                                </li>
                                <li className="flex items-start text-sm text-slate-700">
                                    <Check className="w-5 h-5 text-cyan-500 mr-3 shrink-0 font-bold" />
                                    <span className="bg-cyan-50 px-1 rounded text-cyan-900 font-semibold">救护车: 全额覆盖</span>
                                </li>
                                <li className="flex items-start text-sm text-slate-700">
                                    <Check className="w-5 h-5 text-cyan-500 mr-3 shrink-0 font-bold" />
                                    <span><strong>政府医院现金津贴:</strong> RM100/天</span>
                                </li>
                                <li className="flex items-start text-sm text-slate-700">
                                    <Check className="w-5 h-5 text-cyan-500 mr-3 shrink-0 font-bold" />
                                    <span>有条件门诊福利</span>
                                ...
                                <li className="flex items-start text-sm text-slate-700">
                                    <Check className="w-5 h-5 text-cyan-500 mr-3 shrink-0 font-bold" />
                                    <span className="bg-cyan-50 px-1 rounded text-cyan-900 font-semibold">包含入院前诊断</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div className="mt-12 max-w-5xl mx-auto bg-white rounded-3xl p-8 md:p-10 border border-slate-200 shadow-sm flex flex-col md:flex-row items-center gap-10">
                    <div className="flex-1">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <h4 className="text-xl font-bold text-brand-navy">了解您的共享账户</h4>
                        </div>
                        <p className="text-slate-600 leading-relaxed text-lg">
                            运作方式如下：您每月的费用分担将自动从您的专用共享账户中扣除。该账户就像您的个人预付钱包，确保您在需要支持时保障始终有效。
                        </p>
                    </div>
            ...
            <div className="mt-16 text-center">
                <p className="text-slate-500 mb-4 font-medium">不确定哪个计划适合您？</p>
                <Button
                    ...
                    onClick={scrollToJoin}
                >
                    <ArrowRight className="w-5 h-5 mr-2" /> 立即开始您的保障计划
                </Button>
            </div>
