            ...
            <div className="flex-1 w-full flex flex-col items-center">
                ...
                <div className="w-full bg-slate-50 p-5 rounded-xl border border-slate-100 mb-8 text-sm text-slate-600 space-y-3 shadow-inner">
                    <div className="flex justify-between items-center border-b border-slate-200 pb-3">
                        <div className="flex items-center text-slate-500 font-medium">本月账单</div>
                        <strong className="text-slate-800 text-base">{bill}</strong>
                    </div>
                    <div className="flex justify-between items-center pt-1">
                        <div className="flex items-center text-slate-500 font-medium">活跃会员</div>
        ...
        >
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 max-w-6xl mx-auto">
                ...
                <ScenarioCard
                    ...
                    members="1,000"
                    outcomeTitle="RM10 / 人"
                    outcomeDesc="计算：RM10,000 ÷ 1,000 名会员"
                    highlight="本月仅需 RM10！"
                />
                ...
                <ScenarioCard
                    ...
                    bill="RM70,000"
                    members="1,000"
                    outcomeTitle="最高分担：RM50"
                    outcomeDesc={<>实际费用 RM70/人，但<span className="text-lg font-black text-brand-navy">上限为 RM50</span>。</>}
                    highlight="RM20 转入下个月"
                />
