    ...
    return (
        <Section className="bg-slate-50 relative overflow-hidden">
            ...
            <div className="text-center mb-16 relative z-10">
                <h2 className="text-3xl md:text-4xl font-bold text-brand-navy">Rakan Kerjasama & Pematuhan Kami</h2>
                <p className="text-lg md:text-xl max-w-3xl mx-auto text-slate-600 mt-4">Pematuhan disahkan dan kerjasama dipercayai untuk ketenangan minda anda.</p>
            ...
            <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-center max-w-6xl mx-auto relative z-10">
                ...
                <div className="w-full lg:w-7/12 text-left">
                    <div className="inline-flex items-center px-3 py-1 bg-white text-brand-teal rounded-full text-xs font-bold uppercase tracking-wider mb-4 border border-brand-teal/20">
                        <ShieldCheck className="w-3 h-3 mr-2" /> Kepercayaan & Keselamatan
                    </div>

                    <h3 className="text-3xl font-bold text-brand-navy mb-2">Diiktiraf Patuh Syariah</h3>
                    <p className="text-lg text-brand-blue font-medium mb-6">Disahkan dan Disemak oleh Afsha Shariah Advisory</p>

                    <p className="text-slate-600 mb-10 leading-relaxed">
                        Komitmen We Kongsi terhadap keadilan dan operasi beretika disahkan secara bebas. Keseluruhan program We Kongsi telah diiktiraf secara rasmi sebagai patuh Syariah oleh badan penasihat bebas, Afsha Shariah Advisory. Pensijilan ini memberi jaminan kepada setiap ahli bahawa operasi perkongsian kos perubatan kami adalah telus sepenuhnya, beretika, dan selari dengan prinsip Islam. Lihat sijil rasmi yang dipaparkan di sebelah kanan.
                    </p>

                    <div>
                        <h4 className="text-sm font-bold text-slate-800 uppercase tracking-widest mb-4 border-b border-slate-100 pb-2 inline-block">Rakan Teknologi & Pematuhan Dipercayai</h4>
