            ...
            <div className="flex-1 w-full flex flex-col items-center">
                ...
                <div className="w-full bg-slate-50 p-5 rounded-xl border border-slate-100 mb-8 text-sm text-slate-600 space-y-3 shadow-inner">
                    <div className="flex justify-between items-center border-b border-slate-200 pb-3">
                        <div className="flex items-center text-slate-500 font-medium">Bil bulan ini</div>
                        <strong className="text-slate-800 text-base">{bill}</strong>
                    </div>
                    <div className="flex justify-between items-center pt-1">
                        <div className="flex items-center text-slate-500 font-medium">Ahli Aktif</div>
...
const HowItWorks: React.FC = () => {
    return (
        <Section
            title="Bagaimana Perkongsian Kos Berfungsi?"
            subtitle="Mudah, Adil, dan Telus."
        ...
        >
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 max-w-6xl mx-auto">
                ...
                <ScenarioCard
                    ...
                    title="Bulan Bil Perubatan Rendah"
                    bill="RM10,000"
                    members="1,000"
                    outcomeTitle="RM10 / Seorang"
                    outcomeDesc="Pengiraan: RM10,000 ÷ 1,000 ahli"
                    highlight="Hanya RM10 bulan ini!"
                />
                ...
                <ScenarioCard
                    ...
                    title="Bulan Bil Tinggi (Dihadkan)"
                    bill="RM70,000"
                    members="1,000"
                    outcomeTitle="Syer Maks: RM50"
                    outcomeDesc={<>Kos sebenar RM70/seorang, tetapi <span className="text-lg font-black text-brand-navy">dihadkan kepada RM50</span>.</>}
                    highlight="RM20 dibawa ke bulan hadapan"
                />
                ...
                <ScenarioCard
                    ...
                    title="Bulan Tiada Bil Perubatan"
                    bill="RM0"
                    members="1,000"
                    outcomeTitle="RM0 / Seorang"
                    outcomeDesc="Jika tiada kemasukan, tiada bayaran."
                    highlight="Tenang & Jimat!"
                />
