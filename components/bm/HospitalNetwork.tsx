  ...
  return (
    <section className="py-16 bg-slate-50 border-b border-slate-200 overflow-hidden relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center mb-12">
        <h2 className="text-2xl md:text-3xl font-bold text-brand-navy">Rangkaian Hospital & Klinik Dipercayai Kami</h2>
        <p className="text-slate-500 mt-2 max-w-2xl mx-auto">
          Sebahagian daripada rangkaian perubatan luas yang menghubungkan anda dengan rawatan berkualiti di seluruh negara.
        </p>
