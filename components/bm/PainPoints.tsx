...
import { PAIN_POINTS } from '../../constants_bm';
  ...
  return (
    <Section className="bg-teal-50">
      <div className="text-center mb-16">
        <h2 className="text-3xl md:text-4xl font-bold text-brand-navy mb-4">Apa Yang Ramai Terlepas Pandang Tentang Perlindungan Perubatan</h2>
        <p className="text-lg text-slate-600 max-w-3xl mx-auto">
          Realiti sistem kesihatan di Malaysia penuh cabaran. Adakah anda bersedia menghadapi perkara yang tidak dijangka?
        </p>
      </div>
      ...
      <div className="text-center">
        <Button variant="outline" className="border-brand-navy text-brand-navy hover:bg-brand-navy hover:text-white" onClick={scrollToJoin}>
          <ArrowRight className="w-4 h-4 mr-2" /> Mulakan Pelan Perlindungan Anda Sekarang
        </Button>
      </div>
    </Section>
  );
