                ...
                <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12 bg-white rounded-[2rem] shadow-2xl overflow-hidden relative border border-slate-100">
                    ...
                    <div className="w-full lg:w-1/2 text-left space-y-8 pl-8 pr-8 py-12 lg:pl-16 relative z-10">
                        ...
                        <p className="text-lg text-slate-600 leading-relaxed max-w-lg">
                            Sertai <strong>We Kongsi</strong> hari ini. Jamin ketenangan minda anda dengan perlindungan perubatan <span className="text-brand-navy font-bold decoration-brand-teal underline decoration-4 underline-offset-4">RM1,000,000</span>.
                        </p>
                            ...
                            <div className="flex items-center gap-4 p-4 bg-slate-50 rounded-xl border border-slate-200 max-w-md">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-xs text-slate-500 leading-tight mt-1">
                                        Rakyat Malaysia yang telah menyertai untuk melindungi diri dan keluarga mereka.
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mb-12">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-slate-400 mb-6 leading-relaxed max-w-xs">
                            Perkongsian kos perubatan berteraskan komuniti. Mampu Milik, Telus, Adil. Kami membina negara yang lebih sihat bersama.
                        </p>
                    ...
                    <div>
                        <h4 className="font-bold text-white text-lg mb-6">Penafian</h4>
                        <p className="text-xs text-slate-500 leading-relaxed mb-4">
                            We Kongsi bukan syarikat insurans atau takaful. Program kami dipacu oleh persetujuan sukarela antara ahli untuk berkongsi kos perubatan masing-masing.
                        </p>
