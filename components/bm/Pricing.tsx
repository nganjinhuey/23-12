...
import { MEMBERSHIP_PLANS } from '../../constants_bm';
...
const Pricing: React.FC = () => {
    ...
    return (
        <Section
            title="Apa Yang Anda Bayar?"
            subtitle="Pelan mudah dan mampu milik tanpa yuran tersembunyi."
            id="pricing"
        ...
        >
            ...
            <div className="mb-24">
                <div className="text-center mb-10">
                    <h3 className="text-2xl font-bold text-brand-navy">1. Yuran Keahlian</h3>
                    <p className="text-slate-500">Pilih pelan yang sesuai dengan bajet anda.</p>
                </div>
                            ...
                            {plan.highlight && (
                                <div className="absolute top-0 right-0 transform translate-x-2 -translate-y-2">
                                    <div className="bg-yellow-400 text-yellow-900 px-4 py-1.5 rounded-bl-xl rounded-tr-xl text-xs font-bold shadow-lg shadow-yellow-500/30 flex items-center uppercase tracking-wider">
                                        <Crown size={14} className="mr-1.5" /> Nilai Terbaik
                                    </div>
                                </div>
                            )}
            ...
            <div>
                <div className="text-center mb-10">
                    <h3 className="text-2xl font-bold text-brand-navy">2. Bayaran Akaun Perkongsian</h3>
                    <p className="text-slate-500">Pilih antara dua pakej.</p>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
                    ...
                    <div className="bg-white rounded-3xl border border-blue-200 overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 flex flex-col group h-full">
                        <div className="p-8 bg-blue-50/80 border-b border-blue-100">
                            ...
                            <p className="text-sm text-blue-600 mt-1 font-medium">Tambah Nilai Auto apabila baki &lt; RM50</p>
                        </div>
                        <div className="p-8 flex-1 bg-white">
                            <ul className="space-y-4">
                                <li className="flex items-start text-sm text-slate-700">
                                    <Check className="w-5 h-5 text-blue-500 mr-3 shrink-0" />
                                    <span><strong>Kemasukan Hospital:</strong> Sehingga RM1,000,000/tahun</span>
                                </li>
                                <li className="flex items-start text-sm text-slate-700">
                                    <Check className="w-5 h-5 text-blue-500 mr-3 shrink-0" />
                                    <span><strong>Bilik & Penginapan:</strong> RM150/hari</span>
                                </li>
                                <li className="flex items-start text-sm text-slate-700">
                                    <Check className="w-5 h-5 text-blue-500 mr-3 shrink-0" />
                                    <span><strong>Ambulans:</strong> RM250</span>
                                </li>
                                <li className="flex items-start text-sm text-slate-700">
                                    <Check className="w-5 h-5 text-blue-500 mr-3 shrink-0" />
                                    <span><strong>Elaun Tunai Kerajaan:</strong> RM50/hari</span>
                                </li>
                                <li className="flex items-start text-sm text-slate-700">
                                    <Check className="w-5 h-5 text-blue-500 mr-3 shrink-0" />
                                    <span>Manfaat Pesakit Luar Bersyarat</span>
                                </li>
                                <li className="flex items-start text-sm text-slate-700">
                                    <Check className="w-5 h-5 text-blue-500 mr-3 shrink-0" />
                                    <span>Khairat Kematian: RM10,000</span>
                                </li>
                                <li className="flex items-start text-sm text-slate-400">
                                    <X className="w-5 h-5 text-slate-300 mr-3 shrink-0" />
                                    <span className="line-through">Diagnostik Pra-Hospital</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-3xl border border-cyan-200 overflow-hidden shadow-xl hover:shadow-2xl hover:scale-[1.02] transition-all duration-300 flex flex-col group relative h-full">
                        <div className="p-8 bg-cyan-50/80 border-b border-cyan-200">
                            ...
                            <p className="text-sm text-cyan-700 mt-1 font-medium">Tambah Nilai Auto apabila baki &lt; RM50</p>
                        </div>
                        <div className="p-8 flex-1 bg-white relative">
                            <ul className="space-y-4">
                                <li className="flex items-start text-sm text-slate-700">
                                    <Check className="w-5 h-5 text-cyan-500 mr-3 shrink-0 font-bold" />
                                    <span className="font-medium text-slate-900"><strong>Kemasukan Hospital:</strong> Sehingga RM1,000,000/tahun</span>
                                </li>
                                <li className="flex items-start text-sm text-slate-700">
                                    <Check className="w-5 h-5 text-cyan-500 mr-3 shrink-0 font-bold" />
                                    <span><strong>Bilik & Penginapan:</strong> RM250/hari</span>
                                </li>
                                <li className="flex items-start text-sm text-slate-700">
                                    <Check className="w-5 h-5 text-cyan-500 mr-3 shrink-0 font-bold" />
                                    <span className="bg-cyan-50 px-1 rounded text-cyan-900 font-semibold">Ambulans: Dilindungi Sepenuhnya</span>
                                </li>
                                <li className="flex items-start text-sm text-slate-700">
                                    <Check className="w-5 h-5 text-cyan-500 mr-3 shrink-0 font-bold" />
                                    <span><strong>Elaun Tunai Kerajaan:</strong> RM100/hari</span>
                                </li>
                                <li className="flex items-start text-sm text-slate-700">
                                    <Check className="w-5 h-5 text-cyan-500 mr-3 shrink-0 font-bold" />
                                    <span>Manfaat Pesakit Luar Bersyarat</span>
                                ...
                                <li className="flex items-start text-sm text-slate-700">
                                    <Check className="w-5 h-5 text-cyan-500 mr-3 shrink-0 font-bold" />
                                    <span className="bg-cyan-50 px-1 rounded text-cyan-900 font-semibold">Termasuk Diagnostik Pra-Hospital</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div className="mt-12 max-w-5xl mx-auto bg-white rounded-3xl p-8 md:p-10 border border-slate-200 shadow-sm flex flex-col md:flex-row items-center gap-10">
                    <div className="flex-1">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <h4 className="text-xl font-bold text-brand-navy">Memahami Akaun Perkongsian Anda</h4>
                        </div>
                        <p className="text-slate-600 leading-relaxed text-lg">
                            Begini caranya: Sumbangan perkongsian kos bulanan anda ditolak secara automatik daripada Akaun Perkongsian anda. Akaun ini bertindak seperti dompet prabayar peribadi, memastikan perlindungan anda sentiasa aktif apabila anda memerlukan sokongan.
                        </p>
                    </div>
            ...
            <div className="mt-16 text-center">
                <p className="text-slate-500 mb-4 font-medium">Tidak pasti pelan mana yang sesuai untuk anda?</p>
                <Button
                    ...
                    onClick={scrollToJoin}
                >
                    <ArrowRight className="w-5 h-5 mr-2" /> Mulakan Pelan Perlindungan Anda Sekarang
                </Button>
            </div>
