...
const TESTIMONIAL_DATA = [
  // --- STATIC CARDS ---
  {
    ...
    name: "Muhammad Hanif",
    role: "Kelantan",
    quote: "Bil klinik RM75 saya turun kepada hanya RM10! Itulah kuasa perkongsian—kelegaan kewangan sebenar setiap kali saya melawat doktor.",
    hasReceipt: true,
    image: "image23.jpg"
  },
  {
    ...
    name: "Xin Min",
    role: "19, Perak",
    quote: "Pembedahan RM15,000 yang saya sangat perlukan telah dijayakan oleh WeKongsi. Ia meringankan beban kewangan ibu bapa saya—komuniti benar-benar menyokong saya.",
    hasReceipt: false,
  ...
  },
  {
    ...
    name: "Honey",
    role: "27, Perak",
    quote: "Pembedahan RM45,000 saya? Ditanggung sepenuhnya! Ia memberikan ketenangan minda sepenuhnya dengan hanya membayar RM50 sebulan, jauh lebih murah dari insurans lama.",
    hasReceipt: false,
  ...
  },
  {
    ...
    name: "Niena",
    role: "26, Johor",
    quote: "Berdepan dengan bil kemalangan RM39,000 sangat menakutkan, tetapi WeKongsi menguruskannya dengan lancar. Tiada tekanan, ketenangan minda sepenuhnya.",
    hasReceipt: false,
  ...
  // --- VIDEO CARDS ---
  {
    ...
    name: "Syafiq",
    role: "29, Kelantan",
    quote: "Saya bertukar daripada insurans mahal, dan apabila saya memerlukannya, pembedahan buku lali RM42,000 saya disokong sepenuhnya. WeKongsi memberi nilai lebih baik dan sokongan penuh.",
  ...
  },
  {
    ...
    name: "Ainul & Abdul",
    role: "35 & 42",
    quote: "Pada mulanya kami ragu-ragu, tetapi apabila anak kami dimasukkan ke wad, Surat Jaminan dikeluarkan dengan pantas. Keraguan kami bertukar menjadi keyakinan penuh!",
  ...
  // --- NEW STATIC CARDS ---
  {
    ...
    name: "Mohd Hizam",
    role: "Rakan Rujukan",
    quote: "Ahli saya dimasukkan ke wad kerana keracunan makanan yang teruk, dan sokongan diberikan serta-merta. Melihat tuntutan diuruskan dengan pantas membuktikan WeKongsi memberikan nilai sebenar untuk komuniti saya.",
    image: "image29.jpg"
  },
  {
    id: 8,
    ...
    name: "Puan Maslina",
    role: "Ahli",
    quote: "Anak saya terlibat dalam kemalangan motor, tetapi kerana keluarga kami seramai 8 orang dilindungi, mereka mendapat rawatan yang selesa dan pantas di hospital swasta. WeKongsi menanggung semuanya—kami sangat bersyukur!",
    image: "image30.jpg"
  }
];
  ...
  return (
    <section className="py-16 bg-blue-100 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center mb-10">
        <h2 className="text-2xl md:text-3xl font-bold text-brand-navy">Kisah Kepercayaan & Kelegaan</h2>
        <p className="text-slate-600 mt-2 text-lg font-medium">Kisah sebenar dari ahli komuniti kami yang menemui ketenangan minda.</p>
                ...
                <div className="mb-6 w-full aspect-video bg-slate-100 rounded-xl overflow-hidden relative border border-slate-200 shadow-inner group/video flex items-center justify-center">
                  ...
                  {item.image ? (
                    ...
                    <div className="flex flex-col items-center justify-center text-slate-300 absolute inset-0">
                      ...
                      <span className="text-xs font-bold uppercase tracking-wider">Tonton Kisah</span>
                    </div>
                  )}
                ...
                <div className="mb-6 w-full aspect-video bg-slate-100 rounded-xl overflow-hidden relative border border-slate-200 shadow-inner flex items-center justify-center">
                  {item.image ? (
                    ...
                    <div className="flex flex-col items-center justify-center text-slate-300">
                      ...
                      <span className="text-xs font-bold uppercase tracking-wider">Gambar</span>
                    </div>
                  )}
                </div>
              )}
              ...
              {item.hasReceipt && (
                <div className="mb-6">
                  <div className="flex items-center gap-3 bg-blue-50/80 p-3 rounded-xl border border-blue-100 border-dashed">
                    ...
                    <div>
                      <div className="text-[10px] text-slate-500 font-bold uppercase tracking-wider">Resit Rasmi</div>
                      <div className="text-sm font-bold text-brand-navy">Dibayar: <span className="text-brand-blue">RM10.00</span></div>
                    </div>
                  </div>
                </div>
              )}
